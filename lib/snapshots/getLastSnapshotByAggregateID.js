...
const getLastSnapshotByAggregateID = (aggregateID, callback) => {
  if (!aggregateID) {
  ...
  const collection = cache.read('eventstore_options').snapShotCollectionName || 'snapshots';
...
module.exports = getLastSnapshotByAggregateID;
