...
const cacheName = 'runningSnapshot';
...
const create = async (aggregateId) => {
  return new Promise((resolve) => {
    (async () => {
      ...
      if (cache.read(cacheName) && cache.read(cacheName) === 'true') {
        logger.debug('Snapshot is already running. Additional request is stopped!');
